...
- formulate the null and alternative hypotheses attached to a problem statement;
- undertake hypothesis tests;
- understand and correctly interpret p-values and confidence intervals;
- perform an exploratory data analysis and list the most important features of a dataset.
