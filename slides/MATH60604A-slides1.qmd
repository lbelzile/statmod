...
## 1. Driving exams in Great Britain {.smaller}
...
#| fit.height: 5
#| fig-align: 'center'
#| fig-cap: Sign permutation-based approximation to the null distribution (full) and standard normal approximation
#|   (dashed curve). The value of the test statistic calculated using the original sample
#|   is represented by a vertical line.
#| fig-width: 6
# p-value (sign permutation test)
data(distraction, package = "hecstatmod")
